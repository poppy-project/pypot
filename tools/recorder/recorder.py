...
import poppy_platform.primitives.upright_posture as upp
import poppy_platform.primitives.move_generator as gen
...
class RecorderApp(PyQt4.QtGui.QApplication):
    def __init__(self, argv):
        ...
        self.poppy = pypot.robot.from_configuration('../../poppy_platform/configuration/poppy.xml')

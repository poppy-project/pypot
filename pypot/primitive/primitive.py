...
class MockupMotor(pypot.dynamixel.motor.DxlMotor):
    def __init__(self, m):
        pypot.dynamixel.motor.DxlMotor.__init__(self, m.id, m.name, m.direct, m.offset)
    ...
    @property
    def compliant(self):
        return pypot.dynamixel.motor.DxlMotor.compliant.fget(self)
    ...
    def goal_position(self):
        return pypot.dynamixel.motor.DxlMotor.goal_position.fget(self)
    ...
    def moving_speed(self):
        return pypot.dynamixel.motor.DxlMotor.moving_speed.fget(self)
    ...
    def torque_limit(self):
        return pypot.dynamixel.motor.DxlMotor.torque_limit.fget(self)
    ...
    @property
    def pid(self):
        return pypot.dynamixel.motor.DxlMotor.pid.fget(self)

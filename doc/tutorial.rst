...
The motors are handled in degrees where 0 is considered the central point of the motor turn. For the MX motors, the end points are -180Â° and 180Â°. For the AX and RX motors, these end points are -150Â° to 150Â°.
